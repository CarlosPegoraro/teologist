...
<div class="space-y-8">
    ...
    <div class="border-b border-border pb-10">
        ...
        <div class="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="sm:col-span-3">
                <label for="name" class="block text-sm font-medium leading-6 text-muted-foreground">Nome completo</label>
                <div class="mt-2">
            ...
            <div class="sm:col-span-3">
                <label for="email" class="block text-sm font-medium leading-6 text-muted-foreground">Email</label>
                <div class="mt-2">
            ...
            <div class="sm:col-span-6">
                <label for="title" class="block text-sm font-medium leading-6 text-muted-foreground">Título / Cargo</label>
                <div class="mt-2">
            ...
            <div class="col-span-full">
                <label for="about" class="block text-sm font-medium leading-6 text-muted-foreground">Sobre / Biografia</label>
                <div class="mt-2">
            ...
            <div class="col-span-full">
                <label for="photo_url" class="block text-sm font-medium leading-6 text-muted-foreground">URL da Foto</label>
                <div class="mt-2">
    ...
    <div class="border-b border-border pb-12">
        ...
        <div class="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="sm:col-span-3">
                <label for="site" class="block text-sm font-medium leading-6 text-muted-foreground">Website</label>
                <div class="mt-2">
            ...
            <div class="sm:col-span-3">
                <label for="instagram" class="block text-sm font-medium leading-6 text-muted-foreground">Instagram</label>
                <div class="mt-2">
                    <div class="flex rounded-md bg-background/50 ring-1 ring-inset ring-border focus-within:ring-2 focus-within:ring-inset focus-within:ring-teal-500">
            ...
            <div class="sm:col-span-3">
                <label for="phone" class="block text-sm font-medium leading-6 text-muted-foreground">Telefone</label>
                <div class="mt-2">
...
<div class="mt-6 flex items-center justify-end gap-x-6">
    <a href="{{ route('authors.index') }}" class="text-sm font-semibold leading-6 text-muted-foreground hover:text-foreground">Cancelar</a>
