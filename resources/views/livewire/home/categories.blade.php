...
state([
    'categories' => [
        ...
        [
            'title' => 'Economia',
            'description' => 'Investimentos, finanças e sistemas econômicos.',
            'color' => 'secondary',
            'icon' => 'trending-up',
            'slug' => 'economia'
        ],
        ...
        [
            'title' => 'Filosofia',
            'description' => 'Questões filosóficas e a natureza da existência.',
            'color' => 'secondary',
            'icon' => 'help-circle',
            'slug' => 'filosofia'
        ],
        [
            'title' => 'Direito',
            'description' => 'Leis, justiça e fundamentos jurídicos da sociedade.',
            'color' => 'accent',
            'icon' => 'gavel',
            'slug' => 'direito'
        ],
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid sm:grid-cols-1 lg:grid-cols-3 gap-6">
            @foreach($categories as $category)
                ...
                <a
                    href="#"
                    {{-- Substitua # pelo seu link de categoria, ex: route('categories.show', $category['slug']) --}}
                ...
                >
                    {{-- Glow effect --}}
                    <div
                        class="absolute -inset-px rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                    <div class="relative z-10 flex flex-col items-center">
                        <div class="flex-shrink-0 mb-5">
                            <div
                                class="w-16 h-16 rounded-full bg-background/50 flex items-center justify-center border border-border/50">
