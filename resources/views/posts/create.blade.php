            ...
            <form action="{{ route('posts.store') }}" method="POST">
                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="bg-card/50 backdrop-blur-sm p-8 rounded-xl border border-border space-y-6">
                        <div>
                            <label for="title" class="block text-sm font-medium leading-6 text-gray-300">Título da Discussão</label>
                            <div class="mt-2">
                        ...
                        <div>
                            <label for="content" class="block text-sm font-medium leading-6 text-gray-300">Sua Mensagem</label>
                            <div class="mt-2">
                    ...
                    <div class="mt-8 flex items-center justify-end gap-x-6">
                        <a href="{{ route('posts.index') }}" class="text-sm font-semibold leading-6 text-gray-300 hover:text-foreground">Cancelar</a>
