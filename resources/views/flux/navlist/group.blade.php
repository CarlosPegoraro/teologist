...
>
    <button
        type="button"
        class="group/disclosure-button mb-[2px] flex h-10 w-full items-center rounded-lg text-zinc-500 hover:bg-zinc-800/5 hover:text-zinc-800 lg:h-8 dark:text-foreground/80 dark:hover:bg-white/[7%] dark:hover:text-foreground"
    >
        <div class="ps-3 pe-4">
